...
--
-- Client :  localhost
-- Généré le :  Mer 01 Avril 2026 à 12:48
...
(1, 'Dupont', 'Jean', 'jean.dupont@example.com', '0601020304', 'Paris', '75002', '10 Rue de Rivoli'),
(2, 'TEST', 'TEST', 'TEST@TEST.com', '0606060606', 'test', '00000', 'test');
...
INSERT INTO `contacts` (`IdContact`, `IdCli`, `IdProsp`, `DateRdv`, `HeureRdv`, `DureeRdv`) VALUES
(1, 1, NULL, '2026-04-01 00:00:00', '17:00:00.000000', 1);
...
CREATE TABLE `lignefact` (
  ...
  `Qte` int(11) NOT NULL,
  `PUProd` decimal(8,2) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Contenu de la table `lignefact`
--

INSERT INTO `lignefact` (`IdLigne`, `IdFact`, `IdProd`, `Qte`, `PUProd`) VALUES
(16, 9, 9, 1, '45.00'),
(17, 9, 9, 1, '45.00');
...
INSERT INTO `managers` (`IdMan`, `NomMan`, `PrenomMan`, `MailMan`, `MdpMan`, `IsAdmin`) VALUES
(2, 'Borde', 'Rémy', 'remy.borde34@gmail.com', '$2a$11$kZaDZ16ImxfBi79OkqAOOORq6kvH10lnm.zOozW2jHn6WFEgJytgG', 1);
...
(9, 'efgdsbhsf', 'sfgnfhjdfj', '45.00', 43),
(10, 'eyh dsyht', 'drydsty', '1254.00', 13);
...
--
ALTER TABLE `factures`
  MODIFY `IdFact` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
-- AUTO_INCREMENT pour la table `lignefact`
--
ALTER TABLE `lignefact`
  MODIFY `IdLigne` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT pour la table `managers`
--
ALTER TABLE `managers`
  MODIFY `IdMan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `prospects`
  MODIFY `IdProsp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
